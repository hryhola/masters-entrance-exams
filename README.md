...
2024 року. Уже доступні повний, тематичний і швидкий режими, навчання з
поясненнями та симуляція іспиту з таймером; архітектура передбачає подальше
додавання ЄВІ.
...
- [Етап 2](docs/site/stages/02_CONTENT_PLATFORM.md)
- [Етап 3](docs/site/stages/03_TEST_ENGINE.md)
